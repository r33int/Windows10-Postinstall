...
**xbox branch: Removes Cortana, OneDrive, Windows Defender, useless apps, and services. Preserves Xbox features. Useful for people who use Microsoft Store games.**
...
|Device Guard and Credential Guard hardware readiness tool (dgreadiness)|[Device Guard and Credential Guard hardware readiness tool (dgreadiness)](https://www.microsoft.com/en-us/download/details.aspx?id=53337) Microsoft Sysinternals tool that allows to enable/disable VBS/Device Guard/Credential Guard. Disabling it can improve performance a bit, at the cost of security.|
